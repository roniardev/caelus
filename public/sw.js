!(function () {
  ...
  async function p(e, t, a, s) {
    ...
    for (let i of await e.keys(t, n))
      if (r === w(i.url, a)) return e.match(i, s);
  }
  let y = new Set(),
    _ = async () => {
  ...
  let B = ['continue', 'continuePrimaryKey', 'advance'],
    K = {},
    M = new WeakMap(),
    O = new WeakMap(),
    W = {
  ...
  async function* j(...e) {
    ...
    let a = new Proxy(t, W);
    for (O.set(a, t), C.set(a, k(t)); t; )
      yield a, (t = await (M.get(a) || t.continue())), M.delete(a);
  }
  function $(e, t) {
    return (
  ...
  class V {
    ...
    constructor(e, t, a = 'GET') {
      (this.handler = H(t)), (this.match = e), (this.method = a);
    }
    setCatchHandler(e) {
  ...
  class Z {
    ...
    async cachePut(e, t) {
      ...
      let { cacheName: n, matchOptions: o } = this._strategy,
        ...
        u = h ? await p(l, s.clone(), ['__WB_REVISION__'], o) : null;
      try {
  ...
  class ei {
    _db = null;
    async addEntry(e) {
      let t = (await this.getDb()).transaction(er, 'readwrite', {
        durability: 'relaxed',
      });
    ...
    async getFirstEntryId() {
      let e = await this.getDb(),
        t = await e.transaction(er).store.openCursor();
      return t?.value.id;
    }
    async getAllEntriesByQueueName(e) {
      let t = await this.getDb();
      return (await t.getAllFromIndex(er, en, IDBKeyRange.only(e))) || [];
    }
    async getEntryCountByQueueName(e) {
      return (await this.getDb()).countFromIndex(er, en, IDBKeyRange.only(e));
    }
    async deleteEntry(e) {
      let t = await this.getDb();
      await t.delete(er, e);
    ...
    async getEndEntryFromIndex(e, t) {
      let a = await this.getDb(),
        s = await a.transaction(er).store.index(en).openCursor(e, t);
      return s?.value;
    }
    async getDb() {
      return (
    ...
    _upgradeDb(e, t) {
      t > 0 &&
        ...
        e.deleteObjectStore(er),
        e
          .createObjectStore(er, { autoIncrement: !0, keyPath: 'id' })
          .createIndex(en, en, { unique: !1 });
    }
  }
  class ec {
    _queueName;
    _queueDb;
    constructor(e) {
      (this._queueName = e), (this._queueDb = new ei());
    }
    async pushEntry(e) {
      delete e.id,
  ...
  class el {
    ...
    clone() {
      return new el(this.toObject());
    }
  }
  let eh = 'serwist-background-sync',
    eu = new Set(),
    ed = (e) => {
      let t = {
        request: new el(e.requestData).toRequest(),
  ...
  class em {
    ...
    async _addRequest(
      ...
      let r = {
        requestData: (await el.fromRequest(e.clone())).toObject(),
        timestamp: a,
      };
    ...
    async _removeRequest(e) {
      ...
      if (t) {
        ...
        return a - t.timestamp > s ? this._removeRequest(e) : ed(t);
      }
    }
    ...
    async registerSync() {
      if ('sync' in self.registration && !this._forceSyncFallback)
        try {
          await self.registration.sync.register(`${eh}:${this._name}`);
        } catch (e) {}
    }
    _addSyncListener() {
      'sync' in self.registration && !this._forceSyncFallback
        ? self.addEventListener('sync', (e) => {
            if (e.tag === `${eh}:${this._name}`) {
              let t = async () => {
                let t;
  ...
  class ew extends ee {
    ...
    static copyRedirectedCacheableResponsesPlugin = {
      cacheWillUpdate: async ({ response: e }) =>
        e.redirected ? await eg(e) : e,
    };
    constructor(e = {}) {
      (e.cacheName = m(e.cacheName)),
        super(e),
        (this._fallbackToNetwork = !1 !== e.fallbackToNetwork),
        this.plugins.push(ew.copyRedirectedCacheableResponsesPlugin);
    }
    async _handle(e, t) {
      return (
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
      ...
      for (let [a, s] of this.plugins.entries())
        s !== ew.copyRedirectedCacheableResponsesPlugin &&
          (s === ew.defaultPrecacheCacheabilityPlugin && (e = a),
          s.cacheWillUpdate && t++);
      0 === t
        ? this.plugins.push(ew.defaultPrecacheCacheabilityPlugin)
        : t > 1 && null !== e && this.plugins.splice(e, 1);
    }
  }
  let ep = () => !!self.registration?.navigationPreload,
    ey = (e) => {
      ep() &&
        self.addEventListener('activate', (t) => {
          t.waitUntil(
  ...
  let ex = (e) => {
    ...
    eE = (e, t, a) => {
      if ('string' == typeof e) {
        ...
        return new V(({ url: e }) => e.href === s.href, t, a);
      }
      if (e instanceof RegExp) return new z(e, t, a);
      if ('function' == typeof e) return new V(e, t, a);
  ...
  let eR = 'www.google-analytics.com',
    eq = 'www.googletagmanager.com',
    eS = /^\/(\w+\/)?collect/,
    eD =
      (e) =>
      async ({ queue: t }) => {
    ...
    eN = (e) => {
      let t = ({ url: e }) => e.hostname === eR && eS.test(e.pathname),
        a = new es({ plugins: [e] });
      return [new V(t, a, 'GET'), new V(t, a, 'POST')];
    },
    eC = (e) =>
      new V(
        ({ url: e }) => e.hostname === eR && '/analytics.js' === e.pathname,
        new ea({ cacheName: e }),
        'GET',
      ),
    eT = (e) =>
      new V(
        ({ url: e }) => e.hostname === eq && '/gtag/js' === e.pathname,
        new ea({ cacheName: e }),
        'GET',
      ),
    eP = (e) =>
      new V(
        ({ url: e }) => e.hostname === eq && '/gtm.js' === e.pathname,
        new ea({ cacheName: e }),
        'GET',
      ),
    ek = ({ serwist: e, cacheName: t, ...a }) => {
      let s = d(t),
        r = new ef('serwist-google-analytics', {
          maxRetentionTime: 2880,
          onSync: eD(a),
        });
      for (let t of [eP(s), eC(s), eT(s), ...eN(r)]) e.registerRoute(t);
    };
  class eA {
    _fallbackUrls;
    _serwist;
  ...
  class eU {
    ...
    constructor({
      ...
      if (
        ((this._concurrentPrecaching = t?.concurrency ?? 10),
        (this._precacheStrategy = new ew({
          cacheName: m(t?.cacheName),
          plugins: [
            ...(t?.plugins ?? []),
            new eI({ precacheController: this }),
          ],
          fallbackToNetwork: t?.fallbackToNetwork,
        })),
        ...
        t?.cleanupOutdatedCaches && v(t?.cacheName),
        this.registerRoute(new ev(this, t)),
        t?.navigateFallback &&
          this.registerRoute(
            new G(this.createHandlerBoundToUrl(t?.navigateFallback), {
              allowlist: t?.navigateFallbackAllowlist,
              denylist: t?.navigateFallbackDenylist,
            }),
          ),
        void 0 !== o &&
          ('boolean' == typeof o
        ...
        if (void 0 !== h) {
          let e = new eA({ fallbackUrls: h.entries, serwist: this });
          c.forEach((t) => {
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`);
  ...
  class eB {
    ...
    async setTimestamp(e, t) {
      ...
      let a = {
        ...
        s = (await this.getDb()).transaction(eL, 'readwrite', {
          durability: 'relaxed',
        });
    ...
    constructor(e = {}) {
      (this._config = e),
        ...
        this._config.purgeOnQuotaError &&
          eM(() => this.deleteCacheAndMetadata());
    }
    _getCacheExpiration(e) {
      if (e === f()) throw new i('expire-custom-caches-only');
      let t = this._cacheExpirations.get(e);
      return (
        t || ((t = new eK(e, this._config)), this._cacheExpirations.set(e, t)),
        t
      );
    }
  ...
  class eH {
    cachedResponseWillBeUsed = async ({ request: e, cachedResponse: t }) =>
      t && e.headers.has('range') ? await e$(e, t) : t;
  }
  class eV extends ee {
    async _handle(e, t) {
      let a,
  ...
  let eQ = [
      ...
      },
      {
        ...
        handler: new ea({
          ...
          plugins: [new eO({ maxEntries: 32, maxAgeSeconds: 86400 })],
        }),
      },
      {
        matcher: ({ request: e, url: { pathname: t }, sameOrigin: a }) =>
      ...
      },
      {
        ...
        handler: new ea({
          ...
          plugins: [new eO({ maxEntries: 32, maxAgeSeconds: 3600 })],
          networkTimeoutSeconds: 10,
        }),
      },
    ],
    ez = new eU({
      precacheEntries: [
        ...
        { revision: null, url: '/_next/static/chunks/778-f16fa78dd4e7b71b.js' },
        { revision: null, url: '/_next/static/chunks/989-9aa4c5942ea9e624.js' },
        {
          revision: null,
          url: '/_next/static/chunks/app/(auth)/layout-8d142369860056d8.js',
        },
        {
          revision: null,
        ...
        {
          revision: null,
          url: '/_next/static/chunks/app/(auth)/reset-password/%5Btoken%5D/page-415ce59435741f49.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/(auth)/reset-password/page-0dcac1453fe406e8.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/(auth)/signup/page-0db3ae902ce16ab8.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/(auth)/verify-email/page-8cf33ed08a67c221.js',
        },
        {
          revision: null,
        ...
        {
          revision: null,
          url: '/_next/static/chunks/app/_not-found/page-0e1ad4d99d87ab1e.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/bento/page-a5ec589c605c646c.js',
        },
        {
          revision: null,
        ...
        {
          revision: null,
          url: '/_next/static/chunks/app/~offline/page-602d8e69fd8f575d.js',
        },
        {
          revision: null,
        ...
        {
          revision: null,
          url: '/_next/static/chunks/main-app-16be6704bf034883.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/main-e269311cd63204ba.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/pages/_app-96de4461e85fff50.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/pages/_error-f584c0f130d6f43a.js',
        },
        {
        ...
        {
          revision: null,
          url: '/_next/static/chunks/webpack-5f028d943f3ba7f6.js',
        },
        { revision: null, url: '/_next/static/css/0297b3b7e8883eec.css' },
        { revision: null, url: '/_next/static/css/04e131ef705a1843.css' },
        { revision: null, url: '/_next/static/css/089174a0942aea32.css' },
        { revision: null, url: '/_next/static/css/33fbfd36e81078e7.css' },
        { revision: null, url: '/_next/static/css/90d2ab6805e4689d.css' },
        { revision: null, url: '/_next/static/css/cd2aa6d0b8c4b3ff.css' },
        {
